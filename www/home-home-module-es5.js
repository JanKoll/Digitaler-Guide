(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      "XSEc"); // import { HttpClient } from '@angular/common/http';


      var HomePage = // constructor() {}
      function HomePage(http) {
        ...
        this.http.get('http://localhost:8000/rest/main', {}, {}).then(function (data) {
